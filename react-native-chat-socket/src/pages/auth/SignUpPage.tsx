  ...
  const signUpMutation = useMutation({
    ...
    onSuccess: async response => {
      ...
      if (response?.data) {
        ...
        await setLocalItem(LocalKey.userLogin, JSON.stringify(response.data));
        await setLocalItem(LocalKey.username, email);
        await setLocalItem(LocalKey.password, password);
