...
export class ChatService {
  ...
  async sendMessage(body: SendMessageDto) {
    const senderUser = await this.userRepository.findOneBy({
      id: body.senderId,
    });
    ...
    const receiverUser = await this.userRepository.findOneBy({
      id: body.receiverId,
    });
    ...
    try {
      ...
      // send notification cho người nhận
      this.notificationService.sendNotificationMobile({
